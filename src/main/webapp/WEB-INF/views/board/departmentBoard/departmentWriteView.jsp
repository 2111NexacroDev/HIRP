  ...
  <body>
    ...
    <div id="conts">
      <article id="sub" class="">
        ...
        <form  id="multiform" action="/department/register.hirp" method="post" enctype="multipart/form-data">
      <!--  	<form name="dataForm" id="dataForm" action="/notice/register.hirp" >	-->	
            ...
            <select name="boardCode">
              ...
              <option value="D" selected>부서게시판</option>
            </select>
            <br>
            제목
            <input type="text" name ="deptTitle" style="width:1300px;">
              첨부파일
            ...
            <textarea name="deptContents"></textarea>
