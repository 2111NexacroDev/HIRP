        ...
        <%@ include file="/WEB-INF/views/include/inc_board.jsp" %>
          <article id="sub" class="">
            <%@ include file="/WEB-INF/views/include/inc_nav_right.jsp" %>
              ...
              <form id="multiform" action="/anonymous/register.hirp" method="post" enctype="multipart/form-data">
                <!--  	<form name="dataForm" id="dataForm" action="/notice/register.hirp" >	-->
                게시판 선택
                <select name="boardCode">
                  <option value="N">공지게시판</option>
                  <option value="F">자유게시판</option>
                  <option value="A" selected>익명게시판</option>
                  <option value="D">부서게시판</option>
                </select>
                <br>
                제목
                <input type="text" name="anonymousTitle" style="width:1300px;">
                첨부파일
                ...
                <textarea name="anonymousContents"></textarea>
