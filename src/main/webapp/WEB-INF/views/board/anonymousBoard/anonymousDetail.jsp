			...
			$.ajax({
				...
				success : function(data) { 
					...
					for(var i = 0; i < data.length; i++) {
						...
						var $br = $("<br>");
						var $rWriter 	 = $("<td width='160'><b>").text("익명").append("</b>");
						var $reWriter 	 = $("<td width='160' id='reWriter'><img src='../../../../resources/images/icons/rereply.png' style='width:20px; height:auto; vertical-align: middle; align :right;'/><b>익명</b>");
