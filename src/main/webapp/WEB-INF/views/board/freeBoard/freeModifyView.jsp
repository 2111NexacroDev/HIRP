	...
	<body>
		...
		<div id="conts">
			...
			<article id="sub" class="">
				...
				<div id="freeModify" class="subConts page--board-write">
					<form action="/free/modify.hirp" method="post"
						...
						<table>
							<tr>
								...
								<td><input type="text" name="freeTitle"
										value="${free.freeTitle }"></td>
							</tr>
							<tr>
								<td>작성자</td>
								<td><input type="text" name="emplId" value="${free.emplId }"
										readonly></td>
							</tr>
							<tr>
								<td>내용</td>
								<td><textarea
										name="freeContents">${free.freeContents }</textarea>
								</td>
							</tr>
							<tr>
								<td>첨부파일</td>
