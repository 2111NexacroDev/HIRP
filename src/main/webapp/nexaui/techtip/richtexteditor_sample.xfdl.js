(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("Div01");
            obj.set_async("false");
            obj.set_url("techtip::richtexteditor.xfdl");
            this.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","techtip::richtexteditor.xfdl");
        };
        
        // User Script
        this.addIncludeScript("richtexteditor_sample.xfdl","lib::lib_base.xjs");
        ...
        this.btn_load_onclick = function(obj,  e)
        {
        	...
        	var image1 = "http://localhost/RichTextEditor17/ui/file/richtexteditor/repository/birthday.jpg";
        	var image2 = "http://localhost/RichTextEditor17/ui/file/richtexteditor/repository/ChristmasTree.jpg";
