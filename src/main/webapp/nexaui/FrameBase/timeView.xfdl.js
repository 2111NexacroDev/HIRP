(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"근태번호\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"1\" text=\"아이디\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"2\" text=\"날짜\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"3\" text=\"출근시간\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"4\" text=\"퇴근시간\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"5\" text=\"업무상태\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"6\" text=\"연차사유\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/><Cell col=\"7\" text=\"일근무시간\" border=\"0px none, 0px none, 1px solid #cccccc\" color=\"#333333\"/></Band><Band id=\"body\"><Cell text=\"bind:timeNo\"/><Cell col=\"1\" text=\"bind:emplId\"/><Cell col=\"2\" text=\"bind:timeDate\" displaytype=\"date\"/><Cell col=\"3\" text=\"bind:timeStart\"/><Cell col=\"4\" text=\"bind:timeEnd\"/><Cell col=\"5\" text=\"bind:timeState\"/><Cell col=\"6\" text=\"bind:timeContent\"/><Cell col=\"7\" text=\"bind:timeAccrue\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
