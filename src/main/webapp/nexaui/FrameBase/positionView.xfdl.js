(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"positionSequence\" type=\"STRING\" size=\"256\"/><Column id=\"positionName\" type=\"STRING\" size=\"256\"/><Column id=\"positionCode\" type=\"STRING\" size=\"256\"/><Column id=\"positionUseManager\" type=\"STRING\" size=\"256\"/><Column id=\"positionLevel\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"positionSequence\">test</Col><Col id=\"positionName\">test</Col><Col id=\"positionCode\">test</Col><Col id=\"positionUseManager\">test</Col><Col id=\"positionLevel\">test</Col></Row><Row><Col id=\"positionSequence\">test2</Col><Col id=\"positionName\">test2</Col><Col id=\"positionCode\">test2</Col><Col id=\"positionUseManager\">test2</Col><Col id=\"positionLevel\">test2</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"51\"/><Column size=\"188\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"선택\" color=\"black\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"명칭\" color=\"black\"/><Cell col=\"2\" text=\"코드\" color=\"black\"/><Cell col=\"3\" text=\"사용멤버\" color=\"black\"/></Band><Band id=\"body\"><Cell text=\"bind:positionSequence\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:positionName\"/><Cell col=\"2\" text=\"bind:positionCode\"/><Cell col=\"3\" text=\"bind:positionUseManager\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_Position_Delete","2015","250","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Button("btn_cancel","2105","250","70","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("취소");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_Save","170","250","70","30",null,null,null,null,null,null,this.PositionUpdate.form);
            obj.set_taborder("5");
            obj.set_text("저장");
            this.PositionUpdate.addChild(obj.name, obj);
        ...
        {
        	this.PositionAdd.trackPopupByComponent(obj, -300, 150);
        };
        ...
        {
        	this.PositionUpdate.trackPopupByComponent(obj, -300, 150);
        };

        this.btn_Delete_onclick = function(obj,e)
        {
        	this.PositionDelete.trackPopupByComponent(obj, -300, 150);
        };
        ...
        this.PositionAdd_btn_save_onclick = function(obj,e)
        {
        	...
        	this.transaction(
        		"position_add"// 1.ID
        		,"HirpURL::admin/positionInsert.hirp"// 2.URL
        		,"in_position=ds_position:I" // 3.InDs : F->S jsp(I,U,D)
        		,"" // 4.OutDs : S->F jsp(SELECT)
        		,"" // 5.InVar : F->S(var)
        		,"fn_callback_tran" // 6.callback function(transaction 완료시 호출되는 함수)
        	);
        ...
        this.btn_Position_Delete_onclick = function(obj,e)
        {
        	this.transaction(
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_Position_Delete.addEventHandler("onclick",this.btn_Position_Delete_onclick,this);
            this.btn_cancel.addEventHandler("onclick",this.PositionAdd_btn_cancel_onclick,this);
            ...
            this.PositionUpdate.form.btn_Save.addEventHandler("onclick",this.PositionAdd_btn_save_onclick,this);
            this.PositionUpdate.form.btn_Cancel.addEventHandler("onclick",this.PositionAdd_btn_cancel_onclick,this);
        };
