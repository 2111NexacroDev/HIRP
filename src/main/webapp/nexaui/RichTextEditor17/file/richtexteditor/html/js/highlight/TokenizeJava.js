...
if (!RichTextEditor.Highlight.TokenizeJava)
{
    RichTextEditor.Highlight.TokenizeJava = {
        ...
        init: function ()
        {
            ...
            var keywords = function ()
            {
                ...
                return {
                    ...
                    "interface": result("interface", "keyword"),
                    "package": keywordC,
                    "import": keywordC,
                    "implements": keywordC,
                    "extends": keywordC,
            ...
            function javaTokenState(inside, regexp)
            {
                return function (source, setState)
                {
                    ...
                    var type = javaToken(inside, regexp, source, function (c)
                    {
                        newInside = c;
                    });
            ...
            {
                return highlight.tokenizer(source, startState || javaTokenState(false, true));
            };
