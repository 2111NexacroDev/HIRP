...
public class TimeController {
	...
	public String timeEnd(@ModelAttribute Time time, HttpServletRequest request) {
		...
		// 값을 넣을 때 종류(자료형, String, int 이런거...)를 골라야함. 겟어트리뷰트로 값을 가져오면 자료형이 Object임. 디비에 넣을 때 String으로 넣겠다구 모델에다가 적어놓음.
		// 근데 저 emplId의 자료형으로 정해둔 게 String이라서 앞에(String) 붙혀서 자료형 강제로 바꿔준것(종류 = 자료형 = 데이터형태)
